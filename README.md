# Signal Processing — janelamento, FFT e transformada de Hilbert

Códigos desenvolvidos para a disciplina de Processamento de Sinais e Sistemas Mecânicos Lineares, generalizados para funcionar com **qualquer dado experimental** (não apenas os arquivos do laboratório).
